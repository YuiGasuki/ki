...
document.getElementById("div_ipt_p").innerHTML="";
}else{
...
ul.innerHTML="";
ul.innerHTML+=`<li style="border-bottom-style:solid;" id="math_p"><li>`;
turnon();
}}
...
picno();
function iptno(){
if(document.getElementById("div_ipt_p").innerHTML==""){document.getElementById('div_ipt').focus();}else{
document.getElementById("div_ipt_p").innerHTML="";
